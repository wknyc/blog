...
?>
    ...
    <?php
        ...
        if(function_exists('settings_fields')){
            ...
            <input type="hidden" name="page_options" value="tm_ping,tm_where,tm_style,tm_version,tm_display_page,tm_display_front,tm_display_rss,tm_display_feed,tm_source,tm_url_shortner,tm_space,tm_hashtags,tm_hashtags_tags,tm_api_key" />
            <?php
        }
    ?>
